...
// Function to add event listeners
function addProListeners() {
    // pro1
    pro1.addEventListener("mouseenter", onPro1Enter);
    pro1.addEventListener("mousemove", onPro1Move);
    pro1.addEventListener("mouseleave", onPro1Leave);

    // pro2
    pro2.addEventListener("mouseenter", onPro2Enter);
    pro2.addEventListener("mousemove", onPro2Move);
    pro2.addEventListener("mouseleave", onPro2Leave);
}

// Function to remove event listeners
function removeProListeners() {
    // pro1
    pro1.removeEventListener("mouseenter", onPro1Enter);
    pro1.removeEventListener("mousemove", onPro1Move);
    pro1.removeEventListener("mouseleave", onPro1Leave);

    // pro2
    pro2.removeEventListener("mouseenter", onPro2Enter);
    pro2.removeEventListener("mousemove", onPro2Move);
    pro2.removeEventListener("mouseleave", onPro2Leave);
}

// Function to handle breakpoints
function handleBreakpointChange1() {
    if (breakpoint.matches) {
        // Add event listeners if the screen width is above the breakpoint
        addProListeners();
    } else {
...
// Initial setup
handleBreakpointChange1();

// Re-run breakpoint handling whenever the viewport size changes
breakpoint.addEventListener("change", handleBreakpointChange1);
